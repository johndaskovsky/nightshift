...
## Purpose
Defines the user-facing Nightshift Claude Code skills (create, add-task, update-table, start, test-task, archive) plus internal skills required by the manager.
## Requirements
